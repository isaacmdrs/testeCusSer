...
public class UpdateAccountDataCurrentAccount {
  ...
  public UpdateAccountDataCurrentAccount() {
  }

  public UpdateAccountDataCurrentAccount virtualCardNumber(String virtualCardNumber) {
  ...
  **/
  ...
  public UpdateAccountDataCurrentAccount accountPan(String accountPan) {
    this.accountPan = accountPan;
    return this;
  }

   /**
   * Used for updating all tokens mapped to a single Account PAN and must not be present  when TokenUniqueReference or CurrentFinancialAccountInformation is present for Token Update.
   * @return accountPan
  **/
  @javax.annotation.Nullable
  ...
  public UpdateAccountDataCurrentAccount token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public UpdateAccountDataCurrentAccount alternateAccountIdentifier(String alternateAccountIdentifier) {
  ...
  **/
  ...
  public UpdateAccountDataCurrentAccount financialAccountId(String financialAccountId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateAccountDataCurrentAccount updateAccountDataCurrentAccount = (UpdateAccountDataCurrentAccount) o;
    return Objects.equals(this.virtualCardNumber, updateAccountDataCurrentAccount.virtualCardNumber) &&
        Objects.equals(this.accountPan, updateAccountDataCurrentAccount.accountPan) &&
        Objects.equals(this.token, updateAccountDataCurrentAccount.token) &&
        Objects.equals(this.alternateAccountIdentifier, updateAccountDataCurrentAccount.alternateAccountIdentifier) &&
        Objects.equals(this.financialAccountId, updateAccountDataCurrentAccount.financialAccountId);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateAccountDataCurrentAccount {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateAccountDataCurrentAccount
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateAccountDataCurrentAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateAccountDataCurrentAccount is not found in the empty JSON string", UpdateAccountDataCurrentAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateAccountDataCurrentAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateAccountDataCurrentAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateAccountDataCurrentAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateAccountDataCurrentAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateAccountDataCurrentAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateAccountDataCurrentAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateAccountDataCurrentAccount>() {
           @Override
           public void write(JsonWriter out, UpdateAccountDataCurrentAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateAccountDataCurrentAccount read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UpdateAccountDataCurrentAccount given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UpdateAccountDataCurrentAccount
  * @throws IOException if the JSON string is invalid with respect to UpdateAccountDataCurrentAccount
  */
  public static UpdateAccountDataCurrentAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateAccountDataCurrentAccount.class);
  }

 /**
  * Convert an instance of UpdateAccountDataCurrentAccount to an JSON string
  *
  * @return JSON string
  */
