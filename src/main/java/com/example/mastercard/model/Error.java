...
public class Error {
  ...
  **/
  ...
  public Error recoverable(String recoverable) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(source, reasonCode, errorCode, description, recoverable);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("Recoverable") != null && !jsonObj.get("Recoverable").isJsonNull()) && !jsonObj.get("Recoverable").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `Recoverable` to be a primitive type in the JSON string but got `%s`", jsonObj.get("Recoverable").toString()));
      }
  }
