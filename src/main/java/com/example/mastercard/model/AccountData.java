...
public class AccountData {
  ...
  private AccountDataCurrentAccount currentAccount;

  public AccountData() {
  }

  public AccountData currentAccount(AccountDataCurrentAccount currentAccount) {
  ...
  **/
  ...
  public AccountDataCurrentAccount getCurrentAccount() {
    return currentAccount;
  }

  public void setCurrentAccount(AccountDataCurrentAccount currentAccount) {
    this.currentAccount = currentAccount;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentAccount, accountData.currentAccount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentAccount);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("CurrentAccount") != null && !jsonObj.get("CurrentAccount").isJsonNull()) {
        AccountDataCurrentAccount.validateJsonElement(jsonObj.get("CurrentAccount"));
      }
  }
