...
import com.example.mastercard.model.TokenSuspend;
import com.example.mastercard.model.TokenSuspendResults;
...
public class TokenSuspendApi {
    ...
    public TokenSuspendApi(ApiClient apiClient) {
    ...
    /**
     * Build call for suspendAToken
     * @param id Static endpoint iteration number (Not API Version) (required)
     * @param tokenSuspend JSON object containing parameters for updating a token (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Response to a token suspension </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call suspendATokenCall(String id, TokenSuspend tokenSuspend, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = tokenSuspend;

        // create path and map variables
        String localVarPath = "/{id}/token/suspend"
    ...
    private okhttp3.Call suspendATokenValidateBeforeCall(String id, TokenSuspend tokenSuspend, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling suspendAToken(Async)");
        }

        // verify the required parameter 'tokenSuspend' is set
        if (tokenSuspend == null) {
            throw new ApiException("Missing the required parameter 'tokenSuspend' when calling suspendAToken(Async)");
        }

        return suspendATokenCall(id, tokenSuspend, _callback);
     ...
     */
    public TokenSuspendResults suspendAToken(String id, TokenSuspend tokenSuspend) throws ApiException {
        ApiResponse<TokenSuspendResults> localVarResp = suspendATokenWithHttpInfo(id, tokenSuspend);
     ...
     * @param id Static endpoint iteration number (Not API Version) (required)
     * @param tokenSuspend JSON object containing parameters for updating a token (required)
     * @return ApiResponse&lt;TokenSuspendResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TokenSuspendResults> suspendATokenWithHttpInfo(String id, TokenSuspend tokenSuspend) throws ApiException {
        okhttp3.Call localVarCall = suspendATokenValidateBeforeCall(id, tokenSuspend, null);
        Type localVarReturnType = new TypeToken<TokenSuspendResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Changes a token state from active to suspended. (asynchronously)
     * Used to suspend an active token so that it may not initiate any new transactions. All authorizations for a SUSPENDED token will be declined. Tokens may be suspended by multiple parties (suspenders) concurrently. The token status is updated from ACTIVE to SUSPENDED when the first suspender triggers a suspend action. Additional suspenders can add their suspend action to the list of suspenders. Suspenders can unsuspend only their own suspend action. All suspenders need to perform an unsuspend action to move a token from SUSPENDED to ACTIVE. The token status will only change when the last suspender has unsuspended the token.  For CoF tokens, the only two supported suspenders are issuer and token requestor.  For Apple Pay tokens, there are some differences in behavior versus the general principles. An issuer may add themselves as a suspender to a token already suspended by a cardholder, as above. However, a cardholder cannot suspend a token already suspended by the issuer. As a special case for Apple Pay, an issuer may unsuspend (override) a token already suspended by a cardholder. However, a cardholder cannot unsuspend a token already suspended by the issuer. 
     * @param id Static endpoint iteration number (Not API Version) (required)
     * @param tokenSuspend JSON object containing parameters for updating a token (required)
     ...
     */
    public okhttp3.Call suspendATokenAsync(String id, TokenSuspend tokenSuspend, final ApiCallback<TokenSuspendResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = suspendATokenValidateBeforeCall(id, tokenSuspend, _callback);
        Type localVarReturnType = new TypeToken<TokenSuspendResults>(){}.getType();
